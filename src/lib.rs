...
#[derive(Debug)]
pub struct VelocityAIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VelocityAIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VelocityAI processing");
    
    let mut processor = VelocityAIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VelocityAIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VelocityAIProcessor::new(false);
